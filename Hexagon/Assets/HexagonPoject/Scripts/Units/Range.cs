...
public class Range : Unit
{
    ...
    public override void Attack(Unit enemyUnit)
    {
        if(EnemyUnit == null)
        {
            ...
            missile = new Missile(this, EnemyUnit, 1f, projectilGameObject);
        }               
    }
}
...
public class Missile
{
    ...
    public Missile(Unit myUnit, Unit enemy, float hight, GameObject gameObject)
    {
        position = myUnit.GameObject.transform.position;
    ...
    public void Update()
    {
        ...
        {
            EnemyUnit.CurrentHealth -= MyUnit.Damage;
