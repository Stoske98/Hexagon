...
public class PathFinder : MonoBehaviour
{
    ...
    public static List<Hex> FindPath_AStar_WithNoneWalkableFields(Hex start, Hex end)
    {
    ...
    public static List<Hex> BFS_HexesInRange(Hex start, float MoveRange)
    {
        List<Hex> tilesInRange = new List<Hex>();
    ...
    public static List<Hex> BFS_ListInRangeWithNoneWalkableFields(Hex start, float MoveRange)
    {
        List<Hex> tilesInRange = new List<Hex>();
